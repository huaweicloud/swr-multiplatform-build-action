...
test("test get region from swr image url", async() => {
  const swradd1 = "swr.cn-north-4.xxx/hcloudcli/springbootdemo:9b3d1776f5358a7e0b4562e476fbec629b9baa14";
  expect(utils.getRegionFromEndpoint(swradd1,1,".")).toEqual("cn-north-4");

  const swradd2 = "swr.cn-north-4.xxx/hcloudcli/springbootdemo:v1.1";
  expect(utils.getRegionFromEndpoint(swradd2,1,".")).toEqual("cn-north-4");

  const swradd3 = "swr.cn-north-2.xxx/hcloudcli/jdk19:v1.0.0.1";
