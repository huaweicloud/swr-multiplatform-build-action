...
describe('test install or update docker buildx', () => {
  ...
  test('check install or update docker buildx when download docker buildx success', async () => {
    ...
    jest.spyOn(exec, 'getExecOutput').mockReturnValue( Promise.resolve(
      {exitCode: 0, stdout: 'github.com/docker/buildx v0.0.0 6224def4dd2c3d347eee19db595348c50d7cb491', stderr: ''}
    ));
    await buildx.installOrUpdateDockerBuildX();
...
describe('test get buildx download path', () => {
  ...
  test('check get buildx download path', async () => {
    jest.spyOn(toolCache, 'downloadTool').mockReturnValue(Promise.resolve('/temp/buildx/v0.0.0'));
    expect(await buildx.getBuildXDownlodPath('https://xxx.xxx.xxx/v0.0.0/buildx-v0.0.0.linux-amd64')).toBe('/temp/buildx/v0.0.0');
    expect(core.info).toHaveBeenNthCalledWith(1, 'download docker buildx for install or update from https://xxx.xxx.xxx/v0.0.0/buildx-v0.0.0.linux-amd64');
  ...
  test('check get buildx download path when throw error', async () => {
    ...
    expect(await buildx.getBuildXDownlodPath('https://xxx.xxx.xxx/v0.0.0/buildx-v0.0.0.linux-amd64')).toBe('');
    expect(core.info).toHaveBeenNthCalledWith(1, 'download docker buildx for install or update from https://xxx.xxx.xxx/v0.0.0/buildx-v0.0.0.linux-amd64');
    expect(core.info).toHaveBeenNthCalledWith(2, 'Failed to download docker buildx from https://xxx.xxx.xxx/v0.0.0/buildx-v0.0.0.linux-amd64 error info Error: Server Error.');
...
describe('test get docker buildx download url', () => {
  const testCase = [
      { description: 'get docker buildx download url when platfornm is linux,os arch is amd64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'linux', osArch: 'amd64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.linux-amd64'},
      { description: 'get docker buildx download url when platfornm is linux,os arch is arm-v6 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'linux', osArch: 'arm-v6', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.linux-arm-v6'},
      { description: 'get docker buildx download url when platfornm is linux,os arch is riscv64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'linux', osArch: 'riscv64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.linux-riscv64'},
      { description: 'get docker buildx download url when platfornm is linux,os arch is ppc64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'linux', osArch: 'ppc64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.linux-ppc64'},
      { description: 'get docker buildx download url when platfornm is linux,os arch is s390x and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'linux', osArch: 's390x', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.linux-s390x'},
      { description: 'get docker buildx download url when platfornm is linux,os arch is arm64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'linux', osArch: 'arm64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.linux-arm64'},
      { description: 'get docker buildx download url when platfornm is linux,os arch is x64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'linux', osArch: 'x64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.linux-x64'},
      { description: 'get docker buildx download url when platfornm is win32,os arch is arm64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'win32', osArch: 'arm64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.win32-arm64'},
      { description: 'get docker buildx download url when platfornm is win32,os arch is x64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'win32', osArch: 'x64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.win32-x64'},
      { description: 'get docker buildx download url when platfornm is darwin,os arch is arm64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'darwin', osArch: 'arm64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.darwin-arm64'},
      { description: 'get docker buildx download url when platfornm is darwin,os arch is x64 and tag name is v0.0.0', buildTag: 'v0.0.0', osPlatform: 'darwin', osArch: 'x64', result: 'https://github.com/docker/buildx/releases/download/v0.0.0/buildx-v0.0.0.darwin-x64'},
  ];
  testCase.forEach((item) => {
      ...
      test(`${description}`, async () => {
        ...
        expect(core.info).toHaveBeenNthCalledWith(1, `download buildx version : ${buildTag} for current ${osArch} platform ${osPlatform},download url ${result}`);
      });
  });
});
